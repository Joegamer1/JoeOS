...
Read README.md, docs/DESIGN_SPEC.md, docs/CONSTRUCTION_PLAN.md, docs/ARCHITECTURE.md, SECURITY.md, and CODEX_BUILD_PROMPT.md before substantial changes. JoeOS is an ongoing browser desktop project. DESIGN_SPEC.md is the visual/interaction source of truth; CONSTRUCTION_PLAN.md tracks bounded work and verification, not automatic authorization to perform it.
...
- Finish the requested behavior and document remaining work.
